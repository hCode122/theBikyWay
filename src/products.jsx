...
const ProductList = ({type,data,setData,sum,setSum}) => {
    ...
    return(
        <div className="products">
            { type  == "road" ?  (<>
                <Item addItem={update} data={data} lnk='./src/assets/bike5.jpg' nam='bike A' price='500'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike6.jpg' nam='bike B' price='700'></Item>
                <div className="line"></div>
                <Item addItem={update} data={data} lnk='./src/assets/bike7.jpg' nam='bike C' price='600'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike8.jpg' nam='bike D' price='1500'></Item>
                <div className="line"></div>
                <Item addItem={update} data={data} lnk='./src/assets/bike9.jpg' nam='bike E' price='3600'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike10.jpg' nam='bike F' price='3100'></Item>
                </>
            ) : type == "tour" ?  (<>
                <Item addItem={update} data={data} lnk='./src/assets/bike11.jpg' nam='bike G' price='300'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike12.jpg' nam='bike H' price='1300'></Item>
                <div className="line"></div>
                <Item addItem={update} data={data} lnk='./src/assets/bike13.jpg' nam='bike I' price='800'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike14.jpg' nam='bike J' price='2500'></Item>
                <div className="line"></div>
                <Item addItem={update} data={data} lnk='./src/assets/bike15.jpg' nam='bike K' price='1600'></Item>
                <Item addItem={update} data={data} lnk='./src/assets/bike16.jpg' nam='bike L' price='440'></Item>
                </>
            ) : (<></>)
            }   
        </div>
...
const Item = ({lnk,nam,price,addItem,data}) => {
    ...
    return (
        <div className="item">
            ...
            <div className="price">
                <img src='./src/assets/price.svg'></img>
                <p>Costs: {price}$</p>
            </div>
...
const Cart = ({data,sum}) => {
    ...
    return(
        <>
        <button onClick={cart} className={clas}><img className="cimg" src='./src/assets/cart.svg'></img></button>
